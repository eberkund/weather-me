...
package googleapisconnect

import (
	googleapis "buf.build/googleapis/googleapis"
...
var (
	weatherServiceServiceDescriptor           = googleapis.File_weather_v1_weather_proto.Services().ByName("WeatherService")
...
type WeatherServiceClient interface {
	GetCurrent(context.Context, *connect.Request[googleapis.GetCurrentRequest]) (*connect.Response[googleapis.GetCurrentResponse], error)
	GetForecast(context.Context, *connect.Request[googleapis.GetForecastRequest]) (*connect.Response[googleapis.GetForecastResponse], error)
}
...
func NewWeatherServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WeatherServiceClient {
	...
	return &weatherServiceClient{
		getCurrent: connect.NewClient[googleapis.GetCurrentRequest, googleapis.GetCurrentResponse](
			httpClient,
			baseURL+WeatherServiceGetCurrentProcedure,
			connect.WithSchema(weatherServiceGetCurrentMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getForecast: connect.NewClient[googleapis.GetForecastRequest, googleapis.GetForecastResponse](
			httpClient,
...
type weatherServiceClient struct {
	getCurrent  *connect.Client[googleapis.GetCurrentRequest, googleapis.GetCurrentResponse]
	getForecast *connect.Client[googleapis.GetForecastRequest, googleapis.GetForecastResponse]
}

// GetCurrent calls weather.v1.WeatherService.GetCurrent.
func (c *weatherServiceClient) GetCurrent(ctx context.Context, req *connect.Request[googleapis.GetCurrentRequest]) (*connect.Response[googleapis.GetCurrentResponse], error) {
	return c.getCurrent.CallUnary(ctx, req)
}

// GetForecast calls weather.v1.WeatherService.GetForecast.
func (c *weatherServiceClient) GetForecast(ctx context.Context, req *connect.Request[googleapis.GetForecastRequest]) (*connect.Response[googleapis.GetForecastResponse], error) {
...
func (UnimplementedWeatherServiceHandler) GetCurrent(context.Context, *connect.Request[googleapis.GetCurrentRequest]) (*connect.Response[googleapis.GetCurrentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("weather.v1.WeatherService.GetCurrent is not implemented"))
}

func (UnimplementedWeatherServiceHandler) GetForecast(context.Context, *connect.Request[googleapis.GetForecastRequest]) (*connect.Response[googleapis.GetForecastResponse], error) {
